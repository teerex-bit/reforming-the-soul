...
export async function currentJourneyResume() {
  const [a1, a2, a3, a4, sy1] = await Promise.all([getA1(), getA2(), getA3(), getA4(), getSC1()]);
  return currentJourneyDestination(a1, a2, a3, a4, sy1.progress);
}
