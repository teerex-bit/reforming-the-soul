...
describe('FormationHistory', () => {
  it('renders exact wording, structured data, and AI provenance as distinct records without a transcript', () => {
    ...
    expect(screen.getByText('phase-1-v1')).toBeInTheDocument();
