...
select throws_like($$insert into public.see_clearly_sy3_records(user_id,progress_id,source_sy2_record_id,source_was_linked,self_story_hypothesis) values ('00000000-0000-4000-8000-0000000000e1','e1000000-0000-4000-8000-000000000002','e2000000-0000-4000-8000-000000000001',true,' ')$$,'%self_story_hypothesis_check%','source-only record rejected');
