...
select tables_are(
  ...
  array[
    ...
    'deep_dive_module_progress', 'deep_dive_reflections', 'formation_records', 'journal_entries', 'practice_returns', 'practices',
...
select is(
  (select count(*)::integer from pg_class c join pg_namespace n on n.oid = c.relnamespace
   where n.nspname = 'public' and c.relname in (
     'deep_dive_module_progress', 'deep_dive_reflections', 'profiles', 'user_curriculum_state', 'journal_entries', 'formation_records', 'practices',
